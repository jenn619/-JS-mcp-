 ...
 * Python解密脚本模板生成器
 */
export function generatePythonDecryptScript(params) {
...
export function generatePythonEncryptScript(params) {
    // 加密脚本与解密脚本结构相同，只是函数名不同
    return generatePythonDecryptScript(params);
}
export function generatePythonBruteScript(params) {
...
function generatePythonAES(params) {
...
function generatePythonDES(params) {
...
function generatePythonRSA(params) {
    return `#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
RSA 加密脚本
...
function generatePythonMD5(params) {
    return `#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
MD5 哈希脚本
...
function generatePythonCustom(params) {
    return `#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
自定义加密/解密脚本
