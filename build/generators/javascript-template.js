 ...
 */
export function generateJSDecryptScript(params) {
...
export function generateJSEncryptScript(params) {
    return generateJSDecryptScript(params);
}
export function generateJSBruteScript(params) {
...
function generateJSCustom(params) {
    return `/**
 * 自定义加密/解密脚本
 * 算法: ${params.algorithm}
 * 自动生成 by js-reverse-mcp
